...
from file_handlingcric import load_data
from data_cleaningcricket import clean_data
...
st.bar_chart(total_runs,color='#ffaa00')



st.write("## Proportion of Total Runs by Team")
fig, ax = plt.subplots()
wedges, texts, autotexts = ax.pie(total_runs, labels=total_runs.index, autopct='%1.2f%%', startangle=90, pctdistance=0.85)
for text in texts:
